-- Check and Create Organizational Settings Table
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'organizational_settings table created successfully';
    ELSE
        RAISE NOTICE 'organizational_settings table already exists';
    END IF;
END $$;
